...
import { h as createColorClasses } from './chunk-8eb011dc.js';
...
class SegmentButton {
    ...
    hostData() {
        ...
        return {
            ...
            class: Object.assign({}, createColorClasses(color), { 'segment-button-disabled': disabled, 'segment-button-checked': checked, [`segment-button-layout-${this.layout}`]: this.layout !== undefined })
        };
    }
    render() {
        return [
